...
class Dataset_sentence_test(Dataset):
    def __init__(self, _path):
        if not _path: _path = '/home/eric/oran_semantic_data/SemanticRL/Europarl'
...
if __name__ == "__main__":
    ...
    dict_train = pickle.load(open('/home/eric/oran_semantic_data/SemanticRL/train_dict.pkl', 'rb'))
    ...
    for input_str in SemanticRL_example1:
        ...
        for ckpt_dir in [args.ckpt_pathRL]:#, args.ckpt_pathCE if args.ckpt_resume>0:
            ...
            encoder.load_state_dict(torch.load('/home/eric/oran_semantic_data/SemanticRL/ckpt_AWGN_RL/encoder_epoch201.pth', map_location='cpu'))
            decoder.load_state_dict(torch.load('/home/eric/oran_semantic_data/SemanticRL/ckpt_AWGN_RL/decoder_epoch201.pth', map_location='cpu'))
            embeds_shared.load_state_dict(torch.load('/home/eric/oran_semantic_data/SemanticRL/ckpt_AWGN_RL/embeds_shared_epoch201.pth',  map_location='cpu'))
