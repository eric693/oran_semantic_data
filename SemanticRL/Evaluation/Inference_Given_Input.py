...
def do_test1(input_data, encoder, decoder, normlize_layer, channel, len_batch):
    ...
    with open('/home/mwnl/o-ran_project/o-du-l2/src/5gnrmac/semanticRL_example1_input_data.txt', 'w') as w:
        w.write(str(input_data))
    
    with open('do_test1_encoder_output.txt', 'w') as w:
        w.write(str(encoder_output))
        
    with open('/home/mwnl/o-ran_project/o-du-l2/src/5gnrmac/semanticRL_example1_encoder_output.txt', 'w') as w:
        w.write(str(encoder_output))
    ...
    with open('/home/mwnl/o-ran_project/o-du-l2/src/5gnrmac/semanticRL_example1_normlize_layer_output.txt', 'w') as w:
        w.write(str(normlize_layer_output))
    ...
    with open('/home/mwnl/o-ran_project/o-du-l2/src/5gnrmac/semanticRL_example1_channel_output.txt', 'w') as w:
        w.write(str(channel_output))
    ...
    with open('/home/mwnl/o-ran_project/o-du-l2/src/5gnrmac/semanticRL_example1_decoder_output.txt', 'w') as w:
        w.write(str(decoder_output))
...
SemanticRL_example1 = [
                       'this is a typical sentence used to check the performance',
                      ]
SemanticRL_example2 = [   
...
if __name__ == "__main__":
    ...
    for input_str in SemanticRL_example1: #this is a typical sentence used to check the performance

        input_vector = [dict_train[x] for x in input_str.split(' ')] + [2] #[21860, 24035, 208, 11690, 19658, 2756, 18772, 598, 5227, 3529, 2]
        input_len = len(input_vector) #11
        input_vector = torch.tensor(input_vector)
    
        for ckpt_dir in [args.ckpt_pathRL]:#, args.ckpt_pathCE if args.ckpt_resume>0:
            model_name = os.path.basename(ckpt_dir) #'ckpt_AWGN_RL'
            ...
            sent_a_reference = 'this is a typical sentence used to check the performance'.split()
            ...
            with open('/home/mwnl/o-ran_project/o-du-l2/src/5gnrmac/semanticRL_example1_candidate_sentence.txt', 'w') as w:
                w.write(str(res))
    ...
    for input_str in SemanticRL_example2:
        ...
        for ckpt_dir in [args.ckpt_pathRL]:#, args.ckpt_pathCE if args.ckpt_resume>0:
            ...
            sent_c_reference = 'this is exactly a long sentence with complex structure which might be a challenge for both'.split()
            ...
            with open('/home/mwnl/o-ran_project/o-du-l2/src/5gnrmac/semanticRL_example2_candidate_sentence.txt', 'w') as w:
                w.write(str(res))
